...
export default function DesktopHome() {
  ...
  return (
    <main className="bg-black text-white min-h-screen font-inter">
      ...
      {/* CONTACT US */}
      <section id="contact" className="px-6 md:px-16 py-16 bg-black">
        <div className="max-w-3xl mx-auto bg-zinc-900/80 border border-zinc-800 rounded-3xl p-6 text-center">
          ...
          <Link
            href="/contact"
            className="
              inline-block px-6 py-3 bg-gray-500 hover:bg-gray-600
              text-white font-semibold rounded-full
              transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white
            "
          >
            Contact Us
          </Link>
