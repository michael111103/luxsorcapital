...
const follow: FooterLink[] = [
  ...
  { label: "Instagram", href: "https://instagram.com/repyst.ai", external: true },
    ...
    <footer className="bg-black text-white pt-20 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold mb-6">REPYST</h3>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {year} REPYST. All rights reserved.</p>
