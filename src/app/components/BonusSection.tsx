          ...
          <Reveal>
            <div className="relative max-w-xl">
              {/* image, positioned/sized like the reference, overlapping
                  down into the box */}
              <div className="relative z-10 -mb-12 sm:-mb-16 px-10 sm:px-16">
                <img
                  src="/nomer3.png"
              ...
              <div className="relative rounded-3xl border-t border-b border-white/30 px-6 sm:px-8 pb-12 sm:pb-16 pt-20 sm:pt-24">
