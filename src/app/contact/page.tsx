...
export default function ContactPage() {
  ...
  // kalau ada ?issueType=xxx di URL, isi default
  const defaultType = searchParams.get("issueType") || "";
  // sekali di-mount, set default issueType
    ...
    <div className="min-h-screen bg-black text-white px-4 py-16">
      <div className="max-w-lg mx-auto bg-zinc-900/80 border border-zinc-800 rounded-2xl p-6">
        ...
        <p className="text-white/70 mb-6">
          Ada pertanyaan, kendala, atau usul fitur? Isi form di bawah, kami akan
          membalas dalam 24 jam kerja.
        </p>
